...
section = 'ini-group'
QUPD001 = 'Specific ini-group Task'

uprompt( sconf, section, 'foo');

if uprompt( sconf, section, QUPD001, fp ):
    print "Affirmative"
else:
    print "BOO" 
...
section = 'deploy'
QUD001='Stop The Things (Y/N)'
QUD002='Exact Words In Release Document'


if uprompt(sconf, section, QUD001, True):
    print "Affirmative"
else:
    print "BOO" 
